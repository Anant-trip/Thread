...
spinnerOverlay.id = 'spinner-overlay-demo';
...
// ✅ Load model with correct path and compression support
loader.load(
    ...
    function (gltf) {
        ...
        modelMove();
        console.log('✅ Butterfly model loaded with Draco compression!');
    },
    function (xhr) {
